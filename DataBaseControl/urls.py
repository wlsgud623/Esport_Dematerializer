...
urlpatterns = [
   ...
   path('ShoseComment/<str:Shosename>/<str:timestamp>',views.Shose_Comment_Views,name="ShoseCommentView"),
   path('ShoseComment/<str:Shosename>/<str:timestamp>/Change',views.Shose_Comment_Rewrite,name="ChangeComment"),
   path('ShoseComment/<str:Shosename>/<str:timestamp>/Delete',views.Shose_Comment_Del,name="CommentDelete"),
